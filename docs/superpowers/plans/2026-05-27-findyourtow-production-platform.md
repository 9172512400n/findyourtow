...
**Goal:** Build FindYourTow into a scalable on-demand towing marketplace with customer request/quote/payment flow, driver operations, admin dispatch, live-tracking architecture, and production-ready data boundaries.
