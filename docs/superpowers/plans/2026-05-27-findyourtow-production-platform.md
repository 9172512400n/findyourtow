...
**Goal:** Build FindYourTow into a scalable Uber-style towing marketplace with customer request/quote/payment flow, driver operations, admin dispatch, live-tracking architecture, and production-ready data boundaries.
