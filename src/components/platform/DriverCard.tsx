    ...
    <div className="rounded-[1.75rem] border border-white/10 bg-black/24 p-5">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 inline-flex items-center gap-1 text-sm font-bold text-white/58">{driver.truckType} · {driver.truckNumber} · <Star size={14} className="fill-white/60" /> {driver.rating}</p>
        </div>
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-500 shadow-[0_14px_40px_rgba(59,130,246,.35)]"><Truck size={27} /></div>
      </div>
